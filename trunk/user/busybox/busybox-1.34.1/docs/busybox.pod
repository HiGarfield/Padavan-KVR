...
Currently available applets include:
	...
	egrep, env, ether-wake, expr, false, fgrep, find, flock, free,
	fuser, getopt, grep, gunzip, gzip, head, hexdump, hostname, hwclock,
	ifconfig, inetd, insmod, kill, killall, klogd, ln, logger, login,
	ls, lsmod, lsof, md5sum, mdev, mkdir, mknod, modinfo, modprobe,
	more, mount, mountpoint, mv, nc, netstat, nice, nohup, nslookup,
	ntpd, passwd, pgrep, pidof, ping, ping6, printf, ps, pwd, rm, rmdir,
	rmmod, route, sed, sendmail, seq, sh, sha256sum, sleep, sort,
	start-stop-daemon, stat, strings, swapoff, swapon, switch_root,
	sync, sysctl, syslogd, tail, tar, tee, telnet, telnetd, test, time,
	top, touch, tr, traceroute, traceroute6, true, udhcpc, umount,
