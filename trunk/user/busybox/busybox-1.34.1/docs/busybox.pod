...
Currently available applets include:
	...
	mknod, modinfo, modprobe, more, mount, mountpoint, mv, nc, netstat,
	nice, nohup, nslookup, ntpd, passwd, pgrep, pidof, ping, ping6,
	printf, ps, pwd, rm, rmdir, rmmod, route, sed, sendmail, seq, sh,
	sha256sum, sleep, sort, start-stop-daemon, stat, strings, swapoff,
